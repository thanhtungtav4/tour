...
export default function TourDetailPage({ params }: PageProps) {
  ...
  const handleShare = (platform: "facebook" | "zalo" | "twitter" | "copy") => {
    const shareUrl = typeof window !== "undefined" ? window.location.href : "";
    const shareTitle = tour?.name || "Đôi Dép Adventure";
    ...
    switch (platform) {
      case "facebook":
        ...
        break;
      case "zalo":
        window.open(`https://zalo.me/share?to=&url=${encodeURIComponent(shareUrl)}`, "_blank", "width=600,height=400");
        break;
      case "twitter":
